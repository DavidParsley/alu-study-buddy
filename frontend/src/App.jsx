...
function App() {
  ...
  const [topic, setTopic] = useState(() => {
    return localStorage.getItem("alu_topic") || ""
  })

  // Persist topic to localStorage
  useEffect(() => {
    localStorage.setItem("alu_topic", topic)
  }, [topic])
  ...
  return (
    <div className="h-screen flex flex-col bg-white overflow-hidden font-sans">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs font-medium tracking-wide" style={{ color: "#D97757" }}>
      ...
      {/* Ethics Footer */}
      <div className="bg-alu-surface border-t border-alu-border px-6 py-2 flex items-center justify-center">
